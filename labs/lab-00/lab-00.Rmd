...
```{r setup-tibble}
usernames <- c("wilsonamy", "saleemelhady", "username 2", "username 3", "username 4") #Extend if necessary
nums <- c(18, 4, NA, NA, NA) #Extend if necessary
colours <- c("powderblue", "plum", "colour 2", "colour 2", "colour 4") #Extend if necessary
hobbies <- c("Hiking", "Squash", "Hobby 2", "Hobby 3", "Hobby 4") #Extend if necessary
