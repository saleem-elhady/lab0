...
```{r setup-tibble}
usernames <- c("wilsonamy", "saleemelhady", "username 2", "kieraclarke", "username 4") #Extend if necessary
nums <- c(18, 4, NA, 5, NA) #Extend if necessary
colours <- c("powderblue", "plum", "colour 2", "plum", "colour 4") #Extend if necessary
